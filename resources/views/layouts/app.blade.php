...
<body class="bg-black text-white min-h-screen font-exo">
    ...
    @if(auth()->user()->isAdmin())
        ...
        <div class="relative group">
            ...
            <!-- Admin Dropdown -->
            <div class="absolute right-0 mt-2 w-48 bg-black/90 backdrop-blur-md border border-cyan-500/30 rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-colors">
                    Dashboard
                </a>
                <a href="{{ route('admin.products.index') }}" class="block px-4 py-2 text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-colors">
                    Manage Products
                </a>
                <a href="{{ route('admin.categories.index') }}" class="block px-4 py-2 text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-colors">
                    Manage Categories
                </a>
            </div>
        </div>
